...
export declare function newMetricUpDownCounter(runtime: Runtime, name: string, unit: string, description: string): MetricUpDownCounter;
...
export declare function addMetricUpDownCounterValue(counter: MetricUpDownCounter, value: number, attrs: JsonString<MetricAttributes>): void;
