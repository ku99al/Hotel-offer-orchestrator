import type { ActivityFunction, ActivityTypeInfoMap, PayloadTypeInfo, QueryDefinition, QueryDefinitionOptions, SearchAttributes, SignalDefinition, SignalDefinitionOptions, UntypedActivities, UpdateDefinition, UpdateDefinitionOptions, WithWorkflowArgs, Workflow, WorkflowResultType, WorkflowReturnType, SearchAttributeUpdatePair, WorkflowDefinitionOptionsOrGetter, WorkflowDefinitionConfig } from '@temporalio/common';
import type { Duration } from '@temporalio/common/lib/time';
import type { temporal } from '@temporalio/proto';
import { type ActivityOptions, type LocalActivityOptions } from './activities';
import type { TimerOptions } from './interceptors';
import type { ChildWorkflowOptions, ChildWorkflowOptionsWithDefaults, ContinueAsNewOptions, DefaultSignalHandler, EnhancedStackTrace, Handler, QueryHandlerOptions, SignalHandlerOptions, UpdateHandlerOptions, WorkflowInfo, UpdateInfo, DefaultUpdateHandler, DefaultQueryHandler } from './interfaces';
 ...
 * @hidden
 */
export declare function scheduleActivity<R>(activityType: string, args: any[], options: ActivityOptions, typeInfo?: PayloadTypeInfo): Promise<R>;
/**
 * Schedule an activity and run outbound interceptors
 * @hidden
 */
export declare function scheduleLocalActivity<R>(activityType: string, args: any[], options: LocalActivityOptions, typeInfo?: PayloadTypeInfo): Promise<R>;
/**
 ...
 * ```
 */
export declare function proxyActivities<A = UntypedActivities>(options: ActivityProxyOptions<A>): ActivityInterfaceFor<A>;
/**
 ...
 */
export declare function proxyLocalActivities<A = UntypedActivities>(options: LocalActivityProxyOptions<A>): LocalActivityInterfaceFor<A>;
/**
...
type ChildWorkflowDefinitionOptions = Omit<ChildWorkflowOptions, 'typeInfo'> & {
    typeInfo?: never;
};
/**
 ...
 * In order to query the child, use a {@link WorkflowClient} from an Activity.
 */
export declare function startChild<T extends Workflow>(workflowFunc: T, options: WithWorkflowArgs<T, ChildWorkflowDefinitionOptions>): Promise<ChildWorkflowHandle<T>>;
/**
 * Start a child Workflow execution
 *
 ...
 * @return The result of the child Workflow.
 */
export declare function executeChild<T extends Workflow>(workflowFunc: T, options: WithWorkflowArgs<T, ChildWorkflowDefinitionOptions>): Promise<WorkflowResultType<T>>;
/**
 * Start a child Workflow execution and await its completion.
 *
 * **Override for Workflows that accept no arguments**.
 ...
 */
export declare function defineUpdate<Ret, Args extends any[] = [], Name extends string = string>(name: Name, options?: UpdateDefinitionOptions): UpdateDefinition<Ret, Args, Name>;
/**
 ...
 */
export declare function defineSignal<Args extends any[] = [], Name extends string = string>(name: Name, options?: SignalDefinitionOptions): SignalDefinition<Args, Name>;
/**
 ...
 * A definition can be reused in multiple Workflows.
 */
export declare function defineQuery<Ret, Args extends any[] = [], Name extends string = string>(name: Name, options?: QueryDefinitionOptions): QueryDefinition<Ret, Args, Name>;
/**
 ...
 * @experimental
 */
export declare function defineWorkflowOptions<A extends any[], RT>(fn: (...args: A) => Promise<RT>, config: WorkflowDefinitionConfig): void;
