...
import type { RetryPolicy, CommonWorkflowOptions, HandlerUnfinishedPolicy, SearchAttributes, SignalDefinition, UpdateDefinition, QueryDefinition, Duration, VersioningIntent, TypedSearchAttributes, SearchAttributePair, Priority, WorkerDeploymentVersion, VersioningBehavior, InitialVersioningBehavior, SuggestContinueAsNewReason, PayloadTypeInfo } from '@temporalio/common';
...
export declare class ContinueAsNew extends Error {
    ...
    readonly eventGroupMarkers?: NonNullable<coresdk.workflow_commands.IWorkflowCommand["eventGroupMarkers"]> | undefined;
    /**
     ...
     * @internal
     */
    constructor(command: coresdk.workflow_commands.IContinueAsNewWorkflowExecution, eventGroupMarkers?: NonNullable<coresdk.workflow_commands.IWorkflowCommand["eventGroupMarkers"]> | undefined);
}
/**
