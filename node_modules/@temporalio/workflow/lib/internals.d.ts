...
import type { ActivitySerializationContext, FailureConverter, PayloadConverter, ProtoFailure, Workflow, WorkflowFunctionWithOptions, WorkflowQueryAnnotatedType, WorkflowSignalAnnotatedType, WorkflowUpdateAnnotatedType, WorkflowUpdateType, WorkflowUpdateValidatorType, VersioningBehavior, WorkflowDefinitionOptions, WorkflowSerializationContext, PayloadTypeInfo, TypeInfo } from '@temporalio/common';
import { HandlerUnfinishedPolicy } from '@temporalio/common';
import type { coresdk } from '@temporalio/proto';
import type { RNG } from './alea';
import { RootCancellationScope } from './cancellation-scope';
import type { QueryInput, SignalInput, StartNexusOperationOutput, UpdateInput, WorkflowExecuteInput, WorkflowInterceptors } from './interceptors';
import type { DefaultSignalHandler, StackTraceFileLocation, WorkflowInfo, WorkflowCreateOptionsInternal, ActivationCompletion, DefaultUpdateHandler, DefaultQueryHandler } from './interfaces';
...
export declare class Activator implements ActivationHandler {
    ...
    private readonly patchDecisions;
    ...
    private readonly patchActivationCallback?;
    typeInfo?: PayloadTypeInfo;
    constructor({ info, now, showStackTraceSources, sourceMap, getTimeOfDay, randomnessSeed, registeredActivityNames, stackTracesEnabled, failureExceptionTypeNames, patchActivationCallback, }: WorkflowCreateOptionsInternal);
