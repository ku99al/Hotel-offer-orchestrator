...
function initRuntime(options) {
    const activator = new internals_1.Activator({
        ...
        info: fixPrototypes({
            ...
            unsafe: {
                ...
                random: (0, random_helpers_1.createUnsafeRandomSource)(OriginalMathRandom),
            },
        }),
    });
    ...
    try {
        ...
        if ((0, common_1.isWorkflowFunctionWithOptions)(activator.workflow)) {
        ...
        if ((0, common_1.isWorkflowFunctionWithStaticOptions)(activator.workflow)) {
...
function activate(activation, batchIndex = 0) {
    ...
    activator.rethrowSynchronously = true;
    try {
        const intercept = (0, interceptor_composition_1.composeInterceptors)(activator.interceptors.internals, 'activate', ({ activation }) => {
...
function concludeActivation() {
    ...
    try {
        ...
        const intercept = (0, interceptor_composition_1.composeInterceptors)(activator.interceptors.internals, 'concludeActivation', (input) => input);
...
function dispose() {
    ...
    try {
        try {
            const dispose = (0, interceptor_composition_1.composeInterceptors)(activator.interceptors.internals, 'dispose', async () => { });
            dispose({});
        }
        catch (e) {
            error = e;
