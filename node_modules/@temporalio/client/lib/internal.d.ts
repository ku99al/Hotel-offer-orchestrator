 ...
 * @hidden
 */
export declare const InternalWorkflowUpdateOptionsSymbol: unique symbol;
 ...
 * @hidden
 */
export declare const InternalWorkflowSignalOptionsSymbol: unique symbol;
 ...
 * @hidden
 */
export declare const InternalWorkflowQueryOptionsSymbol: unique symbol;
 ...
 * @hidden
 */
export type InternalWorkflowHandle = WorkflowHandle & InternalWorkflowSignalOptions & InternalWorkflowQueryOptions & {
    /**
     ...
     */
    startUpdate<Ret, Args extends any[]>(def: UpdateDefinition<Ret, Args> | string, options: WorkflowUpdateOptions & {
        args?: Args;
        waitForStage: typeof WorkflowUpdateStage.ACCEPTED;
    } & InternalWorkflowUpdateOptions): Promise<WorkflowUpdateHandle<Ret>>;
};
/**
 ...
 * @hidden
 */
export declare const InternalActivityStartOptionsSymbol: unique symbol;
