import type { CommonWorkflowOptions, SignalDefinition, SignalTypeInfo, WithWorkflowArgs, Workflow, VersioningOverride, PayloadTypeInfo } from '@temporalio/common';
...
type WorkflowSignalWithStartOptionsBase<SignalArgs extends any[]> = SignalArgs extends [any, ...any[]] ? WorkflowSignalWithStartOptionsWithArgs<SignalArgs> : WorkflowSignalWithStartOptionsWithoutArgs<SignalArgs>;
...
export type WorkflowSignalWithStartOptions<SignalArgs extends any[] = []> = WorkflowSignalWithStartOptionsBase<SignalArgs> & SignalWithStartTypeInfoOptions;
export interface WorkflowSignalWithStartOptionsWithoutArgs<SignalArgs extends any[]> extends Omit<WorkflowOptions, 'requestEagerStart'> {
    /**
...
export interface WorkflowSignalWithStartOptionsWithArgs<SignalArgs extends any[]> extends Omit<WorkflowOptions, 'requestEagerStart'> {
    /**
     * SignalDefinition or name of signal
     */
    signal: SignalDefinition<SignalArgs> | string;
