...
class ScheduleClient extends base_client_1.BaseClient {
    ...
    async _createScheduleHandler(input) {
        ...
        const req = {
            ...
            schedule: {
                ...
                action: await (0, schedule_helpers_1.encodeScheduleAction)(this.dataConverter, this.options.namespace, opts.action, headers),
            ...
            searchAttributes: opts.searchAttributes || opts.typedSearchAttributes
                ? {
        ...
        try {
            ...
            if (externalStorage) {
                ...
                await (0, internal_non_workflow_1.visit)(req, internal_non_workflow_1.walkCreateScheduleRequest, (0, internal_non_workflow_1.extstoreStoreOptions)(externalStorage, {
                    initialTarget: {
                        kind: 'workflow',
                        namespace: this.options.namespace,
    ...
    async _describeSchedule(scheduleId) {
        try {
            ...
            const externalStorage = this.dataConverter.externalStorage;
            await (0, internal_non_workflow_1.visit)(response, internal_non_workflow_1.walkDescribeScheduleResponse, (0, internal_non_workflow_1.extstoreInboundOptions)(externalStorage));
            return response;
        }
        catch (err) {
    ...
    async _updateSchedule(scheduleId, opts, header) {
        const req = {
            ...
            schedule: {
                spec: (0, schedule_helpers_1.encodeScheduleSpec)(opts.spec),
                action: await (0, schedule_helpers_1.encodeScheduleAction)(this.dataConverter, this.options.namespace, opts.action, header),
                policies: (0, schedule_helpers_1.encodeSchedulePolicies)(opts.policies),
                state: (0, schedule_helpers_1.encodeScheduleState)(opts.state),
            },
        ...
        try {
            ...
            if (externalStorage) {
                const startWorkflow = req.schedule?.action?.startWorkflow;
                await (0, internal_non_workflow_1.visit)(req, internal_non_workflow_1.walkUpdateScheduleRequest, (0, internal_non_workflow_1.extstoreStoreOptions)(externalStorage, {
                    initialTarget: {
                        kind: 'workflow',
                        namespace: this.options.namespace,
                        id: startWorkflow?.workflowId ?? undefined,
    ...
    async *list(options) {
        ...
        for (;;) {
            ...
            const externalStorage = this.dataConverter.externalStorage;
            await (0, internal_non_workflow_1.visit)(response, internal_non_workflow_1.walkListSchedulesResponse, (0, internal_non_workflow_1.extstoreInboundOptions)(externalStorage));
        ...
        return {
            ...
            async describe() {
                ...
                return {
                    ...
                    action: await (0, schedule_helpers_1.decodeScheduleAction)(this.client.dataConverter, this.client.options.namespace, raw.schedule.action),
