 ...
 * @module
 */
import type { Duration, PayloadTypeInfo, SearchAttributePair, SignalTypeInfo, TypeInfo, TypedSearchAttributes } from '@temporalio/common';
import { Headers, Next } from '@temporalio/common';
import type { temporal } from '@temporalio/proto';
import type { NexusOperationHandle } from './nexus-client';
import type { NexusOperationExecutionCount, NexusOperationExecutionDescription, NexusOperationExecution, NexusOperationIdConflictPolicy, NexusOperationIdReusePolicy } from './nexus-types';
import type { CompiledScheduleOptions } from './schedule-types';
import type { ActivityExecutionDescription, ActivityExecutionInfo, CountActivityExecutions, DescribeWorkflowExecutionResponse, RequestCancelWorkflowExecutionResponse, TerminateWorkflowExecutionResponse, WorkflowExecution } from './types';
import type { CompiledWorkflowOptions, WorkflowUpdateOptions } from './workflow-options';
import type { ActivityDescribeOptions, ActivityHandle, ActivityOptions, ActivityOptionsUpdate, ActivityOptionsUpdateResult, ActivityPauseOptions, ActivityUnpauseOptions } from './activity-client';
export { Headers, Next };
...
export interface WorkflowClientInterceptor {
     ...
     */
    terminate?: (input: WorkflowTerminateInput, next: Next<this, 'terminate'>) => Promise<TerminateWorkflowExecutionResponse>;
    /**
...
export interface NexusClientInterceptor {
    ...
    startOperation?: (input: StartNexusOperationInput, next: Next<this, 'startOperation'>) => Promise<NexusOperationHandle>;
    ...
    describe?: (input: DescribeNexusOperationInput, next: Next<this, 'describe'>) => Promise<NexusOperationExecutionDescription>;
...
export interface ActivityClientInterceptor {
     ...
     * @experimental Activity Operator Commands are experimental. APIs may be subject to change.
     */
    updateOptions?: (input: ActivityUpdateOptionsInput, next: Next<this, 'updateOptions'>) => Promise<ActivityOptionsUpdateResult>;
    /**
     * Intercept a service call to updateActivityExecutionOptions(restoreOriginal=true)
     *
     * @experimental Activity Operator Commands are experimental. APIs may be subject to change.
     */
    restoreOriginalOptions?: (input: ActivityRestoreOriginalOptionsInput, next: Next<this, 'restoreOriginalOptions'>) => Promise<ActivityOptionsUpdate>;
}
/**
