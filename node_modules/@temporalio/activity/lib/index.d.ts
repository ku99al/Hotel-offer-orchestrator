...
import type { ActivityDefinitionOptions, ActivityFunction, Logger, Duration, MetricMeter, Priority, ActivityCancellationDetails, RetryPolicy } from '@temporalio/common';
import type { ActivityCancellationDetailsHolder } from '@temporalio/common/lib/activity-cancellation-details';
import type { Client } from '@temporalio/client';
export { ActivityDefinitionOptions, ActivityFunction, ActivityInterface, // eslint-disable-line @typescript-eslint/no-deprecated
ActivityTypeInfoMap, ApplicationFailure, CancelledFailure, CompleteAsyncError, UntypedActivities, } from '@temporalio/common';
/**
 ...
 * @experimental
 */
export declare function setActivityOptions<Args extends any[], ReturnType>(options: ActivityDefinitionOptions, fn: ActivityFunction<Args, ReturnType>): void;
