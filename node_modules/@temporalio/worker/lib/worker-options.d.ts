...
import type { ActivityFunction, DataConverter, LoadedDataConverter, MetricMeter, VersioningBehavior, WorkerDeploymentVersion } from '@temporalio/common';
...
export interface WorkerOptions {
     ...
     * @experimental
     */
    workflowFailureErrorTypes?: Record<'*' | (string & {}), ('NondeterminismError' | 'DeterminismViolationError' | 'Error' | (string & {}))[]>;
    /**
 ...
 */
export interface ReplayWorkerOptions extends Omit<WorkerOptions, 'connection' | 'namespace' | 'taskQueue' | 'activities' | 'nexusServices' | 'tuner' | 'maxConcurrentActivityTaskExecutions' | 'maxConcurrentLocalActivityExecutions' | 'maxConcurrentWorkflowTaskExecutions' | 'maxConcurrentNexusTaskExecutions' | 'maxConcurrentActivityTaskPolls' | 'maxConcurrentWorkflowTaskPolls' | 'maxConcurrentNexusTaskPolls' | 'workflowTaskPollerBehavior' | 'activityTaskPollerBehavior' | 'nexusTaskPollerBehavior' | 'nonStickyToStickyPollRatio' | 'maxHeartbeatThrottleInterval' | 'defaultHeartbeatThrottleInterval' | 'debugMode' | 'enableNonLocalActivities' | 'maxActivitiesPerSecond' | 'maxTaskQueueActivitiesPerSecond' | 'maxEagerActivityReservationsPerWorkflowTask' | 'stickyQueueScheduleToStartTimeout' | 'maxCachedWorkflows' | 'useVersioning' | 'patchActivationCallback'> {
    /**
 ...
 */
export interface CompiledWorkerOptions extends Omit<WorkerOptionsWithDefaults, 'interceptors' | 'activities' | 'nexusServices' | 'tuner'> {
