...
import type { ActivityCancellationDetails, ActivityFunction, ActivitySerializationContext, LoadedDataConverter, MetricMeter, MetricTags, TypeInfo } from '@temporalio/common';
...
import type { ActivityExecuteInput, ActivityInboundCallsInterceptor, ActivityInterceptorsFactory, ActivityOutboundCallsInterceptor } from './interceptors';
...
export declare class Activity {
    ...
    readonly serializationContext: ActivitySerializationContext;
    readonly outputTypeInfo: TypeInfo | undefined;
    ...
    constructor(info: Info, fn: ActivityFunction<any[], any> | undefined, dataConverter: LoadedDataConverter, serializationContext: ActivitySerializationContext, outputTypeInfo: TypeInfo | undefined, heartbeatCallback: Context['heartbeat'], _client: Client | undefined, // May be undefined in the case of MockActivityEnvironment
