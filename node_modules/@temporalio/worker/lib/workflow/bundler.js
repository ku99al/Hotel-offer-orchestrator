...
const patch_module_cache_1 = require("./bundler/patch-module-cache");
...
class WorkflowCodeBundler {
    ...
    constructor(options) {
        ...
        const { logger, workflowsPath, payloadConverterPath, failureConverterPath, workflowInterceptorModules, ignoreModules, preloadModules, webpackConfigHook, } = options;
        ...
        if (ignoredPreloadModules.length > 0) {
            throw new Error(`Cannot preload modules that are also ignored: ${ignoredPreloadModules
                .map((module) => `'${module}'`)
                .join(', ')}`);
        }
    ...
    async createBundle() {
        ...
        const code = memoryFs.readFileSync(bundleFilePath, 'utf8');
        (0, patch_module_cache_1.assertWorkflowModuleCacheGlobalApplied)(code);
    ...
    async bundle(inputFilesystem, outputFilesystem, entry, distDir) {
        ...
        const options = {
            ...
            plugins: [
                ...
                new patch_module_cache_1.InjectWorkflowModuleCacheGlobalPlugin(),
                ...
                new webpack_1.NormalModuleReplacementPlugin(/[\\/](?:@temporalio|contrib)[\\/]interceptors-opentelemetry(?:-v2)?[\\/](?:src|lib)[\\/]workflow[\\/]workflow-imports\.[jt]s$/, './workflow-imports-impl.js'),
            ],
