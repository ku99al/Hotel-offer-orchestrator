...
import type { OmitFirstParam } from '@temporalio/common/lib/type-helpers';
...
import type { ReplayHistoriesIterable, ReplayResult } from './replay';
import type { History } from './runtime';
import { Runtime } from './runtime';
import type { CloseableGroupedObservable } from './rxutils';
import type { CompiledWorkerOptions, CompiledWorkerOptionsWithBuildId, ReplayWorkerOptions, WorkerOptions, WorkerPlugin } from './worker-options';
...
export declare class NativeWorker implements NativeWorkerLike {
    ...
    readonly replaceClient: OmitFirstParam<typeof native.workerReplaceClient>;
...
export declare class Worker {
    ...
    protected _connection?: NativeConnection | undefined;
    ...
    protected readonly evictionsEmitter: EventEmitter<[never]>;
    ...
    /** Logger bound to 'sdkComponent: worker' */
    logger: Logger, metricMeter: MetricMeter, plugins: WorkerPlugin[], _connection?: NativeConnection | undefined, isReplayWorker?: boolean);
    /**
     ...
     * Returns undefined if the worker was created without a connection (e.g., replay workers).
     */
    get connection(): NativeConnection | undefined;
    /**
     ...
     */
    set connection(newConnection: NativeConnection);
    ...
    protected createWorkflow(activation: Decoded<coresdk.workflow_activation.WorkflowActivation>, initWorkflowJob: Decoded<coresdk.workflow_activation.IInitializeWorkflow>, workflowCodecRunner: WorkflowCodecRunner): Promise<WorkflowWithLogAttributes>;
    /**
     ...
     */
    protected processSinkCalls(externalCalls: SinkCall[], logAttributes: Record<string, unknown>): Promise<void>;
    /**
