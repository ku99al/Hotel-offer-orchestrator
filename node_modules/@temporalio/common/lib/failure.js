...
exports.createPayloadValidationError = createPayloadValidationError;
 ...
 */
function createPayloadValidationError(details) {
...
function ensureApplicationFailure(error) {
    ...
    const cause = (0, type_helpers_1.isRecord)(error) && (0, type_helpers_1.isError)(error.cause) ? error.cause : undefined;
