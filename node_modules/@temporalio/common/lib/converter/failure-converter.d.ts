...
export declare class DefaultFailureConverter implements FailureConverter {
     ...
     */
    failureToErrorInner(failure: ProtoFailure, payloadConverter: PayloadConverter, context?: SerializationContext): Error;
     ...
     */
    optionalFailureToOptionalError(failure: ProtoFailure | undefined | null, payloadConverter: PayloadConverter, context?: SerializationContext): Error | undefined;
    /**
     * Converts an error to a Failure proto message if defined or returns undefined
     */
    optionalErrorToOptionalFailure(err: unknown, payloadConverter: PayloadConverter, context?: SerializationContext): ProtoFailure | undefined;
    private nexusFailureToTemporalFailure;
    private temporalFailureToNexusFailure;
}
